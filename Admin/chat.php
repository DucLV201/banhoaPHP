        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title">Mesenger</h3>
                            <div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				...
				<?php
				$sql_select_khachhang = mysqli_query($con,"SELECT * FROM tbl_msg  "); 
				?> 
				<table class="table table-bordered ">
					...
					?> 
					<tr>
						<td><?php echo $row_khachhang['time']; ?></td>						
						<td><?php echo $row_khachhang['mail']; ?></td>
						<td><?php echo $row_khachhang['noidung']; ?></td>
