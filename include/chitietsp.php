...
<!-- page -->
	...
	<!-- //Single Page -->
	<!--Sản Phẩm tương tự-->
	<div class="agileinfo-ads-display col-lg-9" style="margin:auto;">
				<div class="wrapper">
					<!-- first section -->
					<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
					<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Sản phẩm tương tự</h3>
						<div class="row">
							<?php
							$idsanpham =$row_chitiet['category_id'];
							$sql_cate = mysqli_query($con, "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.category_id=$idsanpham  ORDER BY tbl_sanpham.sanpham_id ASC");
