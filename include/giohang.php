		...
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				...
				if(isset($_SESSION['dangnhap_home'])){
					...
					echo '<p style="color:#000;">Vui lòng đăng nhập để thanh toán</p>';
				}
				?>
						...
						?>
							<tr class="rem1">
								...
								<td class="invert">
									...
									<a href="?quanly=giohang&xoa=<?php echo $row_fetch_giohang['giohang_id'] ?>"><img src="images/icons-delete.png" alt=""></a>
								</td>
							</tr>
							<?php
							} 
							...
							<tr>
								<td colspan="7" style="background: #bcb5b5;"><input type="submit" class="btn btn-success" value="Cập nhật giỏ hàng" name="capnhatsoluong">
								<?php 
								...
								?>
								<input type="submit" class="btn btn-primary" value="Đặt hàng ngay" name="thanhtoandangnhap">
