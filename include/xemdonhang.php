						...
						<!-- first section -->
							...
							<div class="col-md-12">
								...
								<table class="table table-bordered ">
									...
									<tr>
										...
										<td><a href="index1.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>">Xem chi tiết</a></td>
										<td><?php 
							...
							<div class="col-md-12">
								...
								<table class="table table-bordered ">
									...
									while($row_donhang = mysqli_fetch_array($sql_select)){ 
										$i++;
										$sum=$sum+$row_donhang['soluong']*$row_donhang['sanpham_giakhuyenmai'];
									?> 
									<tr>
										<td><?php echo $i; ?></td>
										...
										<td><?php echo $row_donhang['soluong']*$row_donhang['sanpham_giakhuyenmai']."VNĐ"; ?></td>
